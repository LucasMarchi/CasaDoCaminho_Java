...
public class VoluntarioRepositoryTest {
	...
	public void deveEncontrarVoluntarioPorNome() {
		Voluntario voluntario = new VoluntarioBuilder().novoVoluntarioPadrao().criar();
		voluntarioRepository.save(voluntario);
		Voluntario voluntarioEncontrado = voluntarioRepository.findByNome(Constantes.VOLUNTARIO_TESTE).get(0);
	...
	public void deveEncontrarVoluntariosComMesmoNome() {
		...
		voluntarioRepository.save(voluntarios);
		List<Voluntario> voluntariosEncontrados = voluntarioRepository.findByNome(Constantes.VOLUNTARIO_TESTE);
	...
	public void deveEncontrarVoluntariosPorProjeto() {
		...
		List<Voluntario> voluntariosEncontrados = voluntarioRepository.findByProjetoNome(Constantes.PROJETO_TESTE);
